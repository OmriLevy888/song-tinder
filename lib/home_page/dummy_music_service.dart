...
class DummyMusicService extends MusicServiceInterface {
  ...
  Future<List<PlaylistModel>> listPlaylists() {
    return Future.delayed(const Duration(seconds: 1), () => _dummyPlaylistData);
  }

  @override
  Future<SongModel> fetchRandom() {
    return Future.delayed(const Duration(seconds: 1), () => _dummySongData[_random.nextInt(_dummySongData.length * 100) % _dummySongData.length]);
  }
}
